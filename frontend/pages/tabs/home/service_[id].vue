<template>
  <IonPage>
    ...
    <IonContent>
      <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 mt-6 px-4">

        <div v-for="provider in providers" class="bg-white flex items-center rounded-lg p-4 shadow-md space-x-8 ">
          <img src="https://avatar.iran.liara.run/public/25" alt="" class="w-12 h-12 rounded-full">
